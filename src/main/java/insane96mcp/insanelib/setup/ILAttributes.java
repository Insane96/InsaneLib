...
public class ILAttributes {
    ...
    public static final DeferredHolder<Attribute, Attribute> MOB_DETECTION_RANGE = REGISTRY.register("mob_detection_range", () -> new RangedAttribute("attribute.name.mob_detection_range", 0d, 0d, 1d));
}
