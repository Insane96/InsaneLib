...
public class ItemDefinitionsFeature extends Feature {
    ...
    public void onTagsUpdated(TagsUpdatedEvent event) {
        ...
        List<ItemDefinition> sorted = new ArrayList<>(ItemDefinitionsReloadListener.DEFINITIONS);
        sorted.sort(Comparator.comparingInt(ItemDefinition::priority));
        ...
        for (ItemDefinition definition : sorted) {
            ...
            for (Item item : BuiltInRegistries.ITEM) {
                ...
                for (ResourceLocation id : definition.removeComponents()) {
                    ...
                    if (type == null) {
                        InsaneLib.LOGGER.warn("ItemDefinitions: unknown component type '{}' in remove_components, skipping", id);
                        continue;
                    }
                    setMap.remove(type);
                    removeSet.add(type);
        ...
        InsaneLib.LOGGER.info("ItemDefinitions: applied components to {} items", affectedItems.size());
    }
